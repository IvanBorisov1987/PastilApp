...
contract MintableToken is StandardToken, BurnableToken, Ownable {
...
contract TalantCoin is MintableToken, Pausable {
    ...
    uint256 public initialSupply = 12000000000 * dec;
